...
.flip-wrap { perspective: 800px; cursor: pointer; margin-bottom: 12px; }
.flip-inner { position: relative; transform-style: preserve-3d; transition: transform .5s; min-height: 150px; }
...
.flip-front { background: #1a2744; border: 1px solid rgba(100,160,255,.25); }
.flip-back  { background: #0f3060; border: 1px solid rgba(100,200,255,.4); transform: rotateY(180deg); }
.flip-icon  { font-size: 2rem; margin-bottom: 8px; }
.flip-term  { font-size: 1.1rem; font-weight: 700; color: #60c8ff; }
.flip-hint  { font-size: .72rem; color: #5a7a99; margin-top: 6px; }
...
<div class="flip-wrap" onclick="this.querySelector('.flip-inner').classList.toggle('flipped')">
<div class="flip-inner">
<div class="flip-front">
  <div class="flip-icon">💬</div>
  <div class="flip-term">Prompt</div>
  <div class="flip-hint">👆 Klicken zum Aufdecken</div>
</div>
<div class="flip-back">
  <div class="flip-def">Der <strong>Text oder die Anweisung</strong>, den du an ein KI-Modell schickst. Er legt fest, was die KI tun soll — von „Erkläre mir..." bis zu komplexen Aufgabenbeschreibungen.</div>
  <div class="flip-tag">Eingabe → Verarbeitung → Ausgabe</div>
</div>
</div>
</div>
...
<div class="flip-front">
  <div class="flip-icon">🔢</div>
  <div class="flip-term">Token</div>
  <div class="flip-hint">👆 Klicken zum Aufdecken</div>
</div>
<div class="flip-back">
  <div class="flip-def">Die <strong>kleinste Verarbeitungseinheit</strong> eines Sprachmodells. Auf Englisch ≈ ¾ Wort, auf Deutsch oft noch weniger. „Unterrichtsmaterial" = 4–5 Tokens. Bestimmt Kosten und Kontextlänge.</div>
  <div class="flip-tag">~0,75 Wörter/Token (EN) · Deutsch oft kürzer</div>
</div>
</div>
</div>
...
<div class="flip-front">
  ...
  <div class="flip-term">Systemprompt</div>
  <div class="flip-hint">👆 Klicken zum Aufdecken</div>
</div>
<div class="flip-back">
  <div class="flip-def">Eine <strong>versteckte Hintergrundanweisung</strong>, die vor dem Gespräch definiert: Rolle, Ton, Sprache, Grenzen. Lernende sehen ihn nicht. Entwickler:innen nutzen ihn, um KI zu konfigurieren.</div>
  <div class="flip-tag" style="background:rgba(167,139,250,.15);color:#a78bfa;">„Du bist ein freundlicher Lernassistent…"</div>
</div>
</div>
</div>
...
<div class="flip-front">
  <div class="flip-icon">🗣️</div>
  <div class="flip-term">Interaktionsprompt</div>
  <div class="flip-hint">👆 Klicken zum Aufdecken</div>
</div>
<div class="flip-back">
  <div class="flip-def">Die <strong>sichtbare Nutzereingabe</strong> im laufenden Gespräch. Jede Nachricht erweitert den Kontext. Anders als der Systemprompt: dynamisch, sichtbar, nutzerseitig.</div>
  <div class="flip-tag">Sichtbar · Dynamisch · Kontextbildend</div>
</div>
</div>
</div>
...
<div class="flip-front">
  <div class="flip-icon">🧠</div>
  <div class="flip-term">LLM</div>
  <div class="flip-hint">👆 Klicken zum Aufdecken</div>
</div>
<div class="flip-back">
  <div class="flip-def"><strong>Large Language Model</strong> — ein neuronales Netz, trainiert auf riesigen Textmengen, um die nächste wahrscheinlichste Token-Folge vorherzusagen. Es „versteht" nicht — es berechnet Wahrscheinlichkeiten. ChatGPT, Claude, Gemma sind LLMs.</div>
  <div class="flip-tag">Kein Verstehen · Mustervorhersage</div>
</div>
</div>
</div>
...
<div class="flip-front">
  <div class="flip-icon">📊</div>
  <div class="flip-term">Parameter</div>
  <div class="flip-hint">👆 Klicken zum Aufdecken</div>
</div>
<div class="flip-back">
  <div class="flip-def">Die <strong>lernbaren Gewichte</strong> des neuronalen Netzes. Beim Training angepasst, bis das Modell nützlich antwortet. GPT-4: ~1,8 Billionen · Gemma 3 9B: 9 Milliarden. Mehr ≠ immer besser.</div>
  <div class="flip-tag" style="background:rgba(16,185,129,.15);color:#10b981;">9B ≈ 5 GB RAM lokal nutzbar!</div>
</div>
</div>
</div>
...
<div class="flip-inner">
<div class="flip-front">
  <div class="flip-icon">📄 vs 📝</div>
  <div class="flip-term">Text vs. PDF</div>
  <div class="flip-hint">👆 Klicken zum Aufdecken</div>
</div>
<div class="flip-back">
  <div class="flip-def"><strong>Reiner Text (Markdown, TXT)</strong> ist für KI optimal: direkt verarbeitbar, kein Layout-Overhead. <strong>PDFs</strong> enthalten Rendering-Daten — KI muss erst extrahieren, was fehleranfällig ist. Für eigene Materialien: immer Textformate!</div>
  <div class="flip-tag">Markdown &gt; PDF für KI-Verarbeitung</div>
</div>
</div>
</div>
...
<div class="flip-front">
  <div class="flip-icon">🪟</div>
  <div class="flip-term">Kontextfenster</div>
  <div class="flip-hint">👆 Klicken zum Aufdecken</div>
</div>
<div class="flip-back">
  <div class="flip-def">Die <strong>maximale Token-Zahl</strong>, die ein Modell gleichzeitig „sehen" kann — inklusive Systemanweisung, Gesprächsverlauf und Antwort. Claude 3.5: 200.000 Tokens. Was außerhalb liegt, existiert für das Modell nicht.</div>
  <div class="flip-tag">Kurzzeitgedächtnis · Pro Anfrage neu</div>
</div>
</div>
</div>
...
<div class="flip-wrap" onclick="this.querySelector('.flip-inner').classList.toggle('flipped')">
<div class="flip-inner" style="min-height:160px;">
<div class="flip-front">
  <div class="flip-icon">🌀</div>
  <div class="flip-term">Halluzination</div>
  <div class="flip-hint">👆 Klicken</div>
</div>
<div class="flip-back">
  <div class="flip-def"><strong>Selbstsicheres Erfinden</strong> von Fakten, Quellen oder Daten durch LLMs. Ursache: Das Modell interpoliert Muster, keine Fakten. Immer kritisch prüfen — vor allem Zahlen und Zitate!</div>
  <div class="flip-tag">Quellen immer verifizieren!</div>
</div>
</div>
</div>
...
<div class="flip-front">
  <div class="flip-icon">🤖</div>
  <div class="flip-term">KI-Agent</div>
  <div class="flip-hint">👆 Klicken</div>
</div>
<div class="flip-back">
  <div class="flip-def">Ein <strong>autonomes KI-System</strong>, das Ziele verfolgt, plant und handelt — ohne bei jedem Schritt Eingaben zu brauchen. Nutzt Werkzeuge: Web-Suche, Code, APIs. <em>Chatbot = fragt, Agent = handelt.</em></div>
  <div class="flip-tag">Ziel → Plan → Aktion → Feedback</div>
</div>
</div>
</div>
...
<div class="flip-front">
  <div class="flip-icon">💾</div>
  <div class="flip-term">Bit & Byte</div>
  <div class="flip-hint">👆 Klicken</div>
</div>
<div class="flip-back">
  <div class="flip-def"><strong>Bit</strong> = 0 oder 1. <strong>Byte</strong> = 8 Bit. KI-Relevanz: Modellgewichte brauchen Speicher. Durch 4-Bit-Quantisierung laufen 9B-Modelle mit ~5 GB RAM — das ermöglicht Local AI auf Schulrechnern!</div>
  <div class="flip-tag" style="background:rgba(16,185,129,.15);color:#10b981;">Quantisierung = Local AI möglich</div>
</div>
</div>
</div>
...
<div class="pb-row">
  <div>
    ...
    <input id="pb-role" type="text" placeholder="z.B. erfahrene Berufsschullehrkraft" oninput="buildPrompt()">
  </div>
  <div>
    <label>📋 Kontext / Bildungsgang</label>
    <input id="pb-ctx" type="text" placeholder="z.B. Straßenwärter, Klasse 11" oninput="buildPrompt()">
  </div>
</div>
<div class="pb-row">
  <div>
    <label>🎯 Aufgabe</label>
    <input id="pb-task" type="text" placeholder="z.B. Lückentext zu Verkehrszeichen erstellen" oninput="buildPrompt()">
  </div>
  <div>
    <label>📐 Gewünschtes Format</label>
    <select id="pb-fmt" onchange="buildPrompt()">
      <option value="Markdown mit Überschriften">Markdown mit Überschriften</option>
      <option value="Lückentext mit Lösungsschlüssel">Lückentext mit Lösungsschlüssel</option>
      <option value="Multiple-Choice-Test (5 Fragen)">Multiple-Choice-Test (5 Fragen)</option>
      <option value="Unterrichtsskizze (tabellarisch)">Unterrichtsskizze (tabellarisch)</option>
      <option value="Erklärvideo-Skript">Erklärvideo-Skript</option>
      <option value="LiaScript-Kurs-Abschnitt">LiaScript-Kurs-Abschnitt</option>
    </select>
  </div>
</div>
<div class="pb-row" style="grid-template-columns:1fr;">
  <div>
    <label>🚫 Einschränkungen</label>
    <input id="pb-limit" type="text" placeholder="z.B. max. Klasse 9 Wortschatz, kein Fachlatein" oninput="buildPrompt()">
  </div>
</div>
<div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:6px;">
  <label style="font-size:.75rem;font-weight:600;color:#5a7a99;text-transform:uppercase;">Generierter Prompt:</label>
  <button onclick="copyPrompt()" style="font-size:.75rem;padding:4px 10px;border-radius:6px;
    background:rgba(96,200,255,.15);border:1px solid rgba(96,200,255,.3);
    color:#60c8ff;cursor:pointer;">📋 Kopieren</button>
</div>
<pre id="pb-out">[Fülle die Felder aus — der Prompt erscheint hier.]</pre>
</div>
...
function buildPrompt(){
  ...
  p+='Aufgabe: '+task+'.\n\n';
  p+='Format: '+fmt+'.\n\n';
  if(limit)p+='Einschränkungen: '+limit+'.';
  document.getElementById('pb-out').textContent=p;
}
function copyPrompt(){
  var t=document.getElementById('pb-out').textContent;
  if(navigator.clipboard){navigator.clipboard.writeText(t).then(function(){alert('Prompt kopiert!');});}
  else{var ta=document.createElement('textarea');ta.value=t;document.body.appendChild(ta);ta.select();document.execCommand('copy');document.body.removeChild(ta);alert('Kopiert!');}
}
buildPrompt();
</script>
...
<div style="display:flex;gap:10px;align-items:center;flex-wrap:wrap;margin-top:10px;">
  <div class="agent-box hl"><div class="agent-icon">🎯</div><div class="agent-name">Ziel</div><div class="agent-role">Aufgabe erhalten</div></div>
  <div style="color:#3a5a80;font-size:1.3rem;">→</div>
  <div class="agent-box"><div class="agent-icon">🤔</div><div class="agent-name">Denken</div><div class="agent-role">Plan erstellen</div></div>
  <div style="color:#3a5a80;font-size:1.3rem;">→</div>
  <div class="agent-box"><div class="agent-icon">⚡</div><div class="agent-name">Handeln</div><div class="agent-role">Tool nutzen</div></div>
  <div style="color:#3a5a80;font-size:1.3rem;">→</div>
  <div class="agent-box"><div class="agent-icon">👀</div><div class="agent-name">Beobachten</div><div class="agent-role">Ergebnis prüfen</div></div>
  <div style="color:#3a5a80;font-size:1.3rem;">→</div>
  <div class="agent-box hl"><div class="agent-icon">✅</div><div class="agent-name">Abschließen</div><div class="agent-role">oder weiter</div></div>
</div>
...
<div class="disc-card" onclick="toggleDisc(this)">
...
<script>
function toggleDisc(card){
  var body=card.querySelector('.disc-body');
